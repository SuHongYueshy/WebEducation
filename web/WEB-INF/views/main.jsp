...
<head>
    ...
    <%
        ...
        if (!currentUser.getUser_name().equals("admin")) {
...
<div data-options="region: 'center'" >
    <div class="easyui-tabs" fit="true" border="false" id="tabs">
        <div title="首页" >
        <div align="center" style="padding-top: 100px;"><font color="red" size="10">欢迎使用教学管理系统</font></div>
        </div>
    </div>
</div>

<div region="west" style="width: 150px;" title="教学管理中心" split="true">
