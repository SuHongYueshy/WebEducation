...
<body background="${pageContext.request.contextPath}/resources/images/login.jpg" style="background-size: 100%;background-repeat: no-repeat">
    ...
    <form action="user" method="post" >
        ...
        <table  width="698" height="509" border="0">
            ...
            <tr height="50">
                <td width="15%"></td>
                <td width="7%">帐 号:</td>
                <td><input style="height: 60%" type="text" value="${user_name }" name="user_name"
                           id="user_name"/></td>
                <td width="30%"></td>
            </tr>
            <tr height="50">
